...
implements Listener {
    ...
    public void onCustomPlayerDamage(CustomPlayerDamageEvent event) {
        ...
        for (Damage damage : record) {
            if (damage instanceof GeneralDamage || damage instanceof GeneralDamageByPlayer || !(damage instanceof PlayerDamage) || knocker != null && damage.getTime() <= knockerTime) continue;
            knocker = damage;
    ...
    public static class GeneralDamageByPlayer
    extends PlayerDamage {
        ...
        public String getDeathMessage(UUID getFor) {
            return GeneralDamageByPlayer.wrapName(this.getDamaged(), getFor) + " " + (Object)ChatColor.YELLOW + this.message + " while fighting " + GeneralDamageByPlayer.wrapName(this.getDamager(), getFor) + (Object)ChatColor.YELLOW + ".";
        }
    }
    ...
    extends Damage {
        ...
        @Override
        public String getDeathMessage(UUID getFor) {
            return GeneralDamage.wrapName(this.getDamaged(), getFor) + " " + (Object)ChatColor.YELLOW + this.message + ".";
        }
    }
}
