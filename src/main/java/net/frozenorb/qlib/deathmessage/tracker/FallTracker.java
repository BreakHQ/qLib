...
implements Listener {
    ...
    public void onCustomPlayerDamage(CustomPlayerDamageEvent event) {
        ...
        for (Damage damage : record) {
            if (damage instanceof FallDamage || damage instanceof FallDamageByPlayer || !(damage instanceof PlayerDamage) || knocker != null && damage.getTime() <= knockerTime) continue;
            knocker = damage;
    ...
    public static class FallDamageByPlayer
    extends PlayerDamage {
        ...
        public String getDeathMessage(UUID getFor) {
            return FallDamageByPlayer.wrapName(this.getDamaged(), getFor) + (Object)ChatColor.YELLOW + " hit the ground too hard thanks to " + FallDamageByPlayer.wrapName(this.getDamager(), getFor) + (Object)ChatColor.YELLOW + ".";
        }
    }
    ...
    extends Damage {
        ...
        @Override
        public String getDeathMessage(UUID getFor) {
            return FallDamage.wrapName(this.getDamaged(), getFor) + (Object)ChatColor.YELLOW + " hit the ground too hard.";
        }
    }
}
