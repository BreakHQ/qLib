...
import net.frozenorb.qlib.border.BorderConfiguration;
...
public class Border {
    ...
    public Cuboid setSize(int size, int height, boolean callEvent) {
        ...
        if (callEvent) {
            Bukkit.getPluginManager().callEvent((Event)new BorderChangeEvent(this, previousSize, prev, BorderTask.BorderAction.SET));
        }
        return prev;
    }
