...
import net.frozenorb.qlib.util.countdown.CountdownBuilder;
...
extends BukkitRunnable {
    ...
    Countdown(int seconds, String broadcastMessage, Runnable tickHandler, Runnable broadcastHandler, Runnable finishHandler, Predicate<Player> messageFilter, int ... broadcastAt) {
        ...
        this.broadcastMessage = ChatColor.translateAlternateColorCodes((char)'&', (String)broadcastMessage);
        this.broadcastAt = broadcastAt;
        this.tickHandler = tickHandler;
        this.broadcastHandler = broadcastHandler;
        this.finishHandler = finishHandler;
        this.messageFilter = messageFilter;
        this.runTaskTimer((Plugin)qLib.getInstance(), 0L, 20L);
    }
