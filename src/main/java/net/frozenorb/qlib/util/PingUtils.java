...
import net.frozenorb.qlib.util.NetworkUtils;
...
public final class PingUtils {
    ...
    public static interface Callback {
        public void success(PingResponse var1);
    ...
    implements Runnable {
        ...
        public void run() {
            try (Socket socket = new Socket();){
                ...
                this.callback.success((PingResponse)qLib.GSON.fromJson(jsonResponse, PingResponse.class));
            }
            catch (Exception e) {
