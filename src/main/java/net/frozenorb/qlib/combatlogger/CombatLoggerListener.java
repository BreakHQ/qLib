...
implements Listener {
    ...
    private String getCombatLoggerDeathMessage(UUID player, Player killer, UUID getFor) {
        ...
        return this.wrapLogger(player, getFor) + (Object)ChatColor.YELLOW + " was slain by " + Damage.wrapName(killer.getUniqueId(), getFor) + (Object)ChatColor.YELLOW + " using " + (Object)ChatColor.RED + itemString.trim() + (Object)ChatColor.YELLOW + ".";
    }
